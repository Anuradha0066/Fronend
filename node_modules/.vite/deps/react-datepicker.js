...
function Ee(e3, t3, r2, n, o) {
  ...
  for (var i2 = 0, p = s3.length; i2 < p; i2++) {
    ...
    if (Ne(l) && (!n || e3 === xe(l, c2, r2))) return l;
  }
  return null;
}
function Ne(e3, t3) {
...
function Mt(e3, t3) {
  for (var r2 = [], n = Fe(e3), o = Fe(t3); !isAfter(n, o); ) r2.push(Pe(n)), n = addMonths(n, 1);
  return r2;
}
...
var At = (function(t3) {
  ...
  function o(t4) {
    ...
    return he(this, o), ye(ke(a3 = n.call(this, t4)), "handleClickOutside", (function(e3) {
      ...
      if (a3.props.showYearDropdown && !t5) return import_react2.default.createElement(St, { adjustDateOnChange: a3.props.adjustDateOnChange, date: a3.state.date, onSelect: a3.props.onSelect, setOpen: a3.props.setOpen, dropdownMode: a3.props.dropdownMode, onChange: a3.changeYear, minDate: a3.props.minDate, maxDate: a3.props.maxDate, year: getYear(a3.state.date), scrollableYearDropdown: a3.props.scrollableYearDropdown, yearDropdownItemNumber: a3.props.yearDropdownItemNumber });
    })), ye(ke(a3), "renderMonthDropdown", (function() {
      var t5 = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
      if (a3.props.showMonthDropdown && !t5) return import_react2.default.createElement(_t, { dropdownMode: a3.props.dropdownMode, locale: a3.props.locale, onChange: a3.changeMonth, month: getMonth(a3.state.date), useShortMonthInDropdown: a3.props.useShortMonthInDropdown });
    })), ye(ke(a3), "renderMonthYearDropdown", (function() {
      var t5 = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
      if (a3.props.showMonthYearDropdown && !t5) return import_react2.default.createElement(Et, { dropdownMode: a3.props.dropdownMode, locale: a3.props.locale, dateFormat: a3.props.dateFormat, onChange: a3.changeMonthYear, minDate: a3.props.minDate, maxDate: a3.props.maxDate, date: a3.state.date, scrollableMonthYearDropdown: a3.props.scrollableMonthYearDropdown });
      ...
      if (a3.props.showTimeInput) return import_react2.default.createElement(Lt, { date: t5, timeString: r2, timeInputLabel: a3.props.timeInputLabel, onChange: a3.props.onTimeChange, customTimeInput: a3.props.customTimeInput });
  ...
  function a3(t4) {
    ...
    return he(this, a3), ye(ke(s3 = o.call(this, t4)), "getPreSelection", (function() {
      ...
      if (s3.props.showYearPicker) {
        if (null !== o2 && at(getYear(o2), s3.props)) return;
      } else if (s3.props.showMonthYearPicker) {
        if (null !== o2 && rt(o2, s3.props)) return;
      } else if (null !== o2 && et(o2, s3.props)) return;
      ...
      if (e3) {
        ...
        if (t5 && r2) n = qe(e3, s3.props.minDate, s3.props.maxDate);
        else if (t5) {
